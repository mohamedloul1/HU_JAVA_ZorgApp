...
public class Fysiotherapeut extends Users {

    public Fysiotherapeut(int userId, String UserName)
    {
    ...
    static final int LungRegister= 6;
    ...
    public static void huisArtsStartMenu(){
        ...
        LungRegister lungRegister = new LungRegister();
        ...
        while (runner){
            try {
                System.out.println("\u001B[34mselecteer uw keuze om door te gaan\u001B[0m \n" +
                        ...
                        "[" + Colors.BLUE + "6" + Colors.RESET + "]" + "Longinhoud registreren \n" +
                        "[" + Colors.BLUE + "7" + Colors.RESET + "]" + "Exit");
                ...
                switch (choice) {
                    ...
                    case SearchBypatientNumber:
                        ...
                        break;
                    case LungRegister:
                        lungRegister.insertLungRegister();
                        runner = false;
                        break;
                    case Exit:
                        runner = false;
